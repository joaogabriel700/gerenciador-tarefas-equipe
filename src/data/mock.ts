...
export const mockTasks: Task[] = [
  ...
  { id: 't3', title: 'Reunião de alinhamento', description: 'Definir metas', status: 'Concluído', assigneeId: '1', deadline: '2026-06-10', priority: 'Alta', blocksUsers: ['4', '5'] },
  { id: 't4', title: 'Responder chamados', description: 'Zerar a fila', status: 'Em Andamento', assigneeId: '6', deadline: '2026-06-13', priority: 'Alta' },
  { id: 't5', title: 'Atualizar planilhas', description: 'Fechamento', status: 'Revisão', assigneeId: '8', deadline: '2026-06-12', priority: 'Média', blocksTasks: ['t6'], blocksUsers: ['1'] },
  { id: 't6', title: 'Prospecção de clientes', description: 'Ligar leads', status: 'A Fazer', assigneeId: '5', deadline: '2026-06-16', priority: 'Média' },
